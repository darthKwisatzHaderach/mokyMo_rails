...
Component.create(id: 1, title: 'Компонент 1', project_id: 1, description: 'Описание компонента.')
Component.create(id: 2, title: 'Компонент 2', project_id: 2)
Component.create(id: 3, title: 'Компонент 3', project_id: 2)
Component.create(id: 4, title: 'Компонент 4', project_id: 2)
Component.create(id: 5, title: 'Компонент 5', project_id: 2)
Component.create(id: 6, title: 'Компонент 6', project_id: 2)
Component.create(id: 7, title: 'Компонент 7', project_id: 2)
Component.create(id: 8, title: 'Компонент 8', project_id: 3)
