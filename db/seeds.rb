...
TestObject.create(id: 5, name: 'АРМ подготовки заседаний', version: '1.33.16', project_id: 2)
TestObject.create(id: 6, name: 'АРМ Администратора', version: '1.33.16', project_id: 2)
TestObject.create(id: 7, name: 'АРМ Руководителя', version: '1.33.16', project_id: 2)
TestObject.create(id: 8, name: 'АРМ члена Коллегии', version: '1.33.17', project_id: 2)
TestObject.create(id: 9, name: 'АРМ презентации', version: '1.33.17', project_id: 2)
TestObject.create(id: 10, name: 'АРМ управления заседанием', version: '1.33.17', project_id: 2)
TestObject.create(id: 11, name: 'АРМ подготовки заседаний', version: '1.33.17', project_id: 2)
TestObject.create(id: 12, name: 'АРМ Администратора', version: '1.33.17', project_id: 2)
TestObject.create(id: 13, name: 'АРМ Руководителя', version: '1.33.17', project_id: 2)
